import Semantic.CCPrec.Semantics.SmallStep
import Semantic.CCPrec.Semantics.BigStep
namespace CCPrec
...
theorem step_preserves_wf
  ...
  | step_read hlookup =>
    ...
    rename_i b
    by_cases hb : b
    · simpa only [hb, List.empty_eq] using Exp.WfInHeap.wf_btrue
    · simpa only [hb, List.empty_eq] using Exp.WfInHeap.wf_bfalse
