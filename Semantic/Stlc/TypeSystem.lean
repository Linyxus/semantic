...
/-!
Type system for STLC.

This module defines typing contexts, variable lookup, and typing judgments.
-/
...
/-!
Notation for extending contexts.
-/
infix:65 ",x:" => Ctx.var

/-!
Variable lookup in contexts.
-/
